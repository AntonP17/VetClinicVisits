        ...
        try {
            ...
            if (findVisitStatus == null) {
                ...
                visitStatusRepository.save(VisitStatus.builder()
                        ...
                        .doctorStatus(visitStatusEventDto.doctorStatus())
                        .animalStatus(visitStatusEventDto.animalStatus())
                        .ownerStatus(visitStatusEventDto.ownerStatus())
                ...
                findVisitStatus.setDoctorStatus(visitStatusEventDto.doctorStatus());
                findVisitStatus.setAnimalStatus(visitStatusEventDto.animalStatus());
                findVisitStatus.setOwnerStatus(visitStatusEventDto.ownerStatus());
